...
void CTPseInday::PriceUpdate(cwMarketDataPtr pPriceData)
{
	cout << "test" << endl;
...
void CTPseInday::OnRtnTrade(cwTradePtr pTrade)
{
}

void CTPseInday::OnRtnOrder(cwOrderPtr pOrder, cwOrderPtr pOriginOrder)
{
}

void CTPseInday::OnOrderCanceled(cwOrderPtr pOrder)
{
}

void CTPseInday::OnReady()
{
